...
from mt_dnn.batcher_chr import ChrBatchGen
from mt_dnn.model import MTDNNModel
from mt_dnn.model_chr import ChrMTDNNModel
...
def main():
    ...
    for dataset in args.train_datasets:
        ...
        if args.chr:
            train_data = ChrBatchGen(ChrBatchGen.load(train_path, True, pairwise=pw_task, maxlen=args.max_seq_len, 
    ...
    for dataset in args.test_datasets:
        ...
        if os.path.exists(dev_path):
            if args.chr:
                dev_data = ChrBatchGen(ChrBatchGen.load(dev_path, False, pairwise=pw_task, maxlen=args.max_seq_len,
                                                opt=opt, dataset=dataset),
        ...
        if os.path.exists(test_path):
            if args.chr:
                test_data = ChrBatchGen(ChrBatchGen.load(test_path, False, pairwise=pw_task, 
    ...
    if args.chr:
        model = ChrMTDNNModel(opt, state_dict=state_dict, num_train_step=num_all_batches)
    else:
