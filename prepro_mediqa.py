...
from transformers import CharacterBertTokenizer # use transformers_maison of SaulLu
...
def parse_args():
    ...
    parser.add_argument('--charac', action='store_true', help='character bert.')
    parser.add_argument('--med', action='store_true', help='medical bert.')
...
def main(args):
    ...
    mednli_train_data = mednli_train_data
    mednli_dev_data = mednli_dev_data
    mednli_test_data = mednli_test_data
    ...
    print(mediqa_train_data[0]['uid'])
    print(mediqa_dev_data[0]['uid'])

    #mediqa_dev_data = load_mediqa(mediqa_dir,GLOBAL_MAP['mediqa'], False)
...
if __name__ == '__main__':
    ...
    if args.sci_vocab:
        ...
        bert_tokenizer = BertTokenizer.from_pretrained('/content/drive/MyDrive/NLP/new/character-bert/pretrained-models/medical_bert')
    elif args.charac:
        bert_tokenizer = CharacterBertTokenizer()
    else:
